                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    @can('card_batch_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.card-batches.index') }}">
                                            {{ trans('cruds.cardBatch.title') }}
                                        </a>
                                    @endcan
                                    @can('store_access')
                                        <a class="dropdown-item" href="{{ route('frontend.stores.index') }}">
                                    ...
                                    @endcan
                                    @can('order_access')
                                        <a class="dropdown-item" href="{{ route('frontend.orders.index') }}">
                                    ...
                                    @endcan
                                    @can('customer_access')
                                        <a class="dropdown-item" href="{{ route('frontend.customers.index') }}">
