    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.rewards.update", [$reward->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description">{!! old('description', $reward->description) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('points_required') ? 'is-invalid' : '' }}" type="number" name="points_required" id="points_required" value="{{ old('points_required', $reward->points_required) }}" step="1" required>
          ...
          return loader.file
            .then(function (file) {
              return new Promise(function(resolve, reject) {
                ...
                xhr.open('POST', '{{ route('admin.rewards.storeCKEditorImages') }}', true);
