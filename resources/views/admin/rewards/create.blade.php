    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.rewards.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('points_required') ? 'is-invalid' : '' }}" type="number" name="points_required" id="points_required" value="{{ old('points_required', '') }}" step="1" required>
