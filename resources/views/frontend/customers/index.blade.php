                    ...
                    <div class="table-responsive">
                        <table class=" table table-bordered table-striped table-hover datatable datatable-Customer">
                            <thead>
                                <tr>
                                    <th>
                                        {{ trans('cruds.customer.fields.card') }}
                                    </th>
                                    <th>
                                        {{ trans('cruds.customer.fields.stores') }}
                                    </th>
                                    <th>
                                        &nbsp;
                                    </th>
                                ...
                                @foreach($customers as $key => $customer)
                                    <tr data-entry-id="{{ $customer->id }}">
                                        ...
                                        <td>
                                            ...
                                            @can('customer_edit')
                                                <a class="btn btn-xs btn-info" href="{{ route('frontend.customers.edit', $customer->id) }}">
                                                    {{ trans('global.edit') }}
                                                </a>
                                            @endcan
